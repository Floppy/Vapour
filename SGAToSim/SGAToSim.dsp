...
# ADD LINK32 VAL.lib AME_SDK_DLL.lib /nologo /subsystem:console /machine:I386 /include:"?g_oImageProxyBMP@@3V?$CImageFileProxy@VCImageFileBMP@@@@A"
...
# ADD LINK32 kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib VALd.lib AME_SDK_DLL.lib /nologo /subsystem:console /profile /debug /machine:I386 /include:"?g_oImageProxyBMP@@3V?$CImageFileProxy@VCImageFileBMP@@@@A"
